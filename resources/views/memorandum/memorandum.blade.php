        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">ทะเบียนคุมบันทึกข้อความ</h3>
                    @if($editmode)
                    <a class="float-right" href="{{ route('form.memorandum-add') }}" title="send add">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="w3-text-blue">เลขที่บันทึกข้อความ :</label>
...
<script>
    $(document).ready(function () {
        ...
        function getRunNo() {
            $.ajax("{{URL::to('/')}}/api/getMemorandumLastId", {
                type: 'POST',
                processData: false,
                contentType: false,

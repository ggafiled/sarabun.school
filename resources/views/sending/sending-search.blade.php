...
<div class="container-fluid">
        ...
        <div class="col-md-12">
            <div class="card card-primary mx-auto">
                <div class="card-header">
                    <h3 class="card-title">ค้นหาข้อมูลทะเบียนคุมหนังสือส่ง</h3>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary mx-auto">
                <div class="card-header">
                    <h3 class="card-title">แสดงรายการทะเบียนหนังสือส่ง</h3>
                </div>
                <div class="container-fluid mx-auto mt-2 mb-2">
                    <div align="right">
                        <a href="{{ route('form.sending-add') }}" title="send add">
                            <button type="button" class="btn btn-default" data-toggle="modal"
                                data-target="#modal-default">
                                <i class="fa fa-plus-circle"></i>
                                สร้างทะเบียนหนังสือส่ง
                            </button>
                        </a>
                    </div>
                    <form method="post">
